        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{
              ...
              By completing this test, we are able to personalize your experience according to your personality.
            </Typography>
          </Box>
          ...
          <Box sx={{
            ...
            <CustomButton
              ...
              onClick={() => { navigate(ROUTES.ON_BOARDING.EMOTIONAL_INTELLIGENCE.INTRO) }}
            />
            <CustomButton
              label='Take Test'
              sx={{ maxWidth: $({ size: 220 }) }}
              rightIcon={<RightArrowIcon size={$({ size: 24, numeric: true })} />}
              onClick={() => { navigate(ROUTES.ON_BOARDING.BIG_FIVE_PERSONALITY.QUESTIONS) }}
            />
          </Box>
        </Box>
      </Box>
