      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <CustomButton
            ...
            isSecondary={true}
            sx={{ ...(isChecked && currentAnswer === 1 && (isCorrect ? CorrectOptionStyles : IncorrectOptionStyles)) }}
          />
          <CustomButton
            onClick={() => HandleOptionSelection(2)}
            label={questions?.[currentQuestion - 1]?.options?.[1]}
            isSecondary={true}
            sx={{ ...(isChecked && currentAnswer === 2 && (isCorrect ? CorrectOptionStyles : IncorrectOptionStyles)) }}
          />
        </Box>
        ...
        <Box sx={{
          ...
          <CustomButton
            ...
            isSecondary={true}
            sx={{ ...(isChecked && currentAnswer === 3 && (isCorrect ? CorrectOptionStyles : IncorrectOptionStyles)) }}
          />
          <CustomButton
            onClick={() => HandleOptionSelection(4)}
            label={questions?.[currentQuestion - 1]?.options?.[3]}
            isSecondary={true}
            sx={{ ...(isChecked && currentAnswer === 4 && (isCorrect ? CorrectOptionStyles : IncorrectOptionStyles)) }}
          />
        </Box>
      </Box>
