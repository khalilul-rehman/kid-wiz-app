const TopicsData = [
  {
    ...
    subTopics: [
      {
        id: 't1s1',
        title: 'Setting boundaries and consequences',
        sections: [
          {
            id: 't1s1s1',
      ...
      {
        id: 't1s3',
        title: 'Dealing with tantrums and meltdowns',
        sections: [
          {
            id: 't1s3s1',
      ...
      {
        id: 't1s4',
        title: 'Time-outs and alternatives',
        sections: [
          {
            id: 't1s4s1',
  ...
  {
    id: 't7',
    title: 'Online Safety and Digital Well-Being',
    isEnabled: true,
    subTopics: [
      {
        id: 't7s1',
