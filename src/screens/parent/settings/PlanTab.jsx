              ...
              <Box key={`plan-tab-${index}`}
                ...
                <Box sx={{
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      backgroundColor: item.isSelected ? 'transparent' : item.primaryColor,
                      border: item.isSelected ? 'none' : `${$({ size: 4 })} solid ${item.secondaryColor}`,
                      display: 'flex',
                      alignItems: 'center',
                    ...
                    {
                      item.isSelected &&
                      <CheckIcon size={$({ size: 30, numeric: true })} color={item.secondaryColor} />
                    }
                  </Box>
                </Box>
                ...
                <Box sx={{
                  ...
                  <Typography sx={{
                    ...
                    lineHeight: $({ size: 25 }),
                    color: colors.solids.black,
                  }}>{item.introLine}</Typography>

                  {
                    item.details.map((detail, index) => {
                      return (
                        <Box key={`${item.title}-detail-${index}`}
                          sx={{
                            display: 'flex',
                            flexDirection: 'row',
                            alignItems: 'center',
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <TickIcon size={$({ size: 13, numeric: true })} color={item.secondaryColor} />
                          </Box>
                          <Typography sx={{
                            fontSize: $({ size: 13.5 }),
                            fontWeight: '400',
