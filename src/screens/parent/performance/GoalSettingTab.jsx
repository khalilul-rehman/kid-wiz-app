    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography
          ...
          }}>{'Set the daily time goal for your child’s learning journey!'}</Typography>
      </Box>
      ...
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', gap: $({ size: 8 }), alignItems: 'center' }}>
          <CustomTextInput
            ...
            inputContainerStyle={{ padding: `${$({ size: 3 })} ${$({ size: 6 })}` }}
            inputStyle={{
              fontWeight: '600',
              lineHeight: $({ size: 30 }),
        ...
        <CustomButton
          ...
          label='Set!'
          rightIcon={
            <AlarmIcon size={$({ size: 15, numeric: true })} color={colors.white[800]} />
          }
          sx={{
