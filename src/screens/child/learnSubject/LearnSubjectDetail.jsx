            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: $({ size: 8 }) }}>
              <CustomBreadcrumbs
                data={[
                  ...
                  { path: ROUTES.CHILD.LEARN_SUBJECT.DETAIL, title: state?.title || 'N/A' },
                ]}
              />
              ...
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Box onClick={() => navigate(ROUTES.CHILD.LEARN_SUBJECT.INDEX)} sx={{
                    display: 'flex',
                    alignItems: 'center',
